...
var pull_hook_normalizeComponent = __webpack_require__(110)
/* script */
...
var dist_ui = __webpack_require__(123);
...
config.routes = [{
  ...
  component: function component(resolve) {
    __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(276)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
    pageConfig: {
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 277));
  }
}];
...
config.tabBar = {
  groupId: 'abcbf24',
  paths: ['/pages/index', '/pages/member/user'],
  position: 'undefined',
  color: '#7a7e83',
  selectedColor: '#39f',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_touchui_dist_components_tab_bar__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_touchui_dist_components_icon__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_touchui_dist_components_col__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_touchui_dist_components_row__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_touchui_dist_components_nav_bar__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_touchui_dist_components_text__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_touchui_dist_components_slide_menu__ = __webpack_require__(193);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_index_ui__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_member_user_ui__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_member_user_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__pages_member_user_ui__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    Page1: __WEBPACK_IMPORTED_MODULE_3__pages_member_user_ui___default.a
  },
  data: function data() {
    return {
      tabIndex: -1,
  ...
  created: function created() {
    ...
    this.initTabIndex();
    this.$EventService.on('ui-tab-change-abcbf24', function (index) {
...
var components_button = __webpack_require__(112);

// EXTERNAL MODULE: ../touchui/dist/components/image.js
var components_image = __webpack_require__(45);

// EXTERNAL MODULE: ../touchui/dist/components/text.js
var components_text = __webpack_require__(75);

// EXTERNAL MODULE: ../touchui/dist/components/col.js
var col = __webpack_require__(46);
...
var tab_view_body = __webpack_require__(115);

// EXTERNAL MODULE: ../touchui/dist/components/tab-view-header.js
var tab_view_header = __webpack_require__(116);
...
var tab_view = __webpack_require__(117);

// EXTERNAL MODULE: ../touchui/dist/components/page.js + 1 modules
var components_page = __webpack_require__(72);
...
/* harmony default export */ var pages = __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      state: 1,
      showLoading: false,
      imgSrc: __webpack_require__(121),
      currentPage: {
        items1: 1,
        items2: 1,
        items3: 1
  ...
  methods: {
    makeOrder: function makeOrder(item) {
      var that = this;
      this.fetch(api["a" /* Api */].order + '/' + item.id, {
        method: 'PUT',
        data: {
          status: 2
        },
    ...
    noticeOrder: function noticeOrder(item) {
      var itemList = [];
      var partitionIdList = [];
      var partition_id = null;
      var that = this;
      item.partitions.map(function (it) {
      ...
      ui.showActionSheet({
        ...
        success: function success(index) {
          ...
          that.fetch(api["a" /* Api */].order + '/' + item.id, {
            method: 'PUT',
            data: {
              status: 3,
    ...
    frushData: function frushData(status) {
      var limit = 50;
      var that = this;
      var page = this.currentPage['items' + status];
      var mod = 0;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('ui-page', {
    ...
    slot: "header"
  }, [_c('ui-tab-view-header', [_vm._v("已下单")]), _vm._v(" "), _c('ui-tab-view-header', [_vm._v("烹制中")]), _vm._v(" "), _c('ui-tab-view-header', [_vm._v("取餐中")])], 1), _vm._v(" "), _c('template', {
    slot: "body"
  }, [_c('ui-tab-view-body', {
    attrs: {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_touchui_dist_components_image__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_touchui_dist_components_badge__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_touchui_dist_components_icon__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_touchui_dist_components_view__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_touchui_dist_components_col__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_touchui_dist_components_row__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_touchui_dist_components_nav_bar__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_touchui_dist_components_page__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__api_js__ = __webpack_require__(34);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      portraitUrl: __webpack_require__(212),
  ...
  methods: {
    goLogin: function goLogin() {
      ...
      // })
      var that = this;
      __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 220)).then(function (content) {
        ui.showDialog({
          title: '登录',
          content: content,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "ui-tab-page-container page-59dbb6"
  }, [_c('Page0', {
