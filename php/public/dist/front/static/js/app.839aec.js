...
var main_options = {
  ...
  beforeEach: function beforeEach(to, from, next) {
    var tid = to.query.tid;
    var tableHash = to.query.tableHash;
    if (tid && tableHash) {
      dist_ui["a" /* default */].setStorageSync('tableHash', tableHash);
      dist_ui["a" /* default */].setStorageSync('tid', tid);
      dist_ui["a" /* default */].setStorageSync('accessTime', Date.parse(new Date()) / 1000);
    } else {
      tid = dist_ui["a" /* default */].getStorageSync('tid');
      tableHash = dist_ui["a" /* default */].getStorageSync('tableHash');
      var accessTime = dist_ui["a" /* default */].getStorageSync('accessTime');
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      this.fetch(__WEBPACK_IMPORTED_MODULE_9__api_js__["a" /* Api */].order.path, {
        method: 'POST',
        data: { orderGoods: orderGoods, tid: tid, type: type, order_amount: order_amount }
      }).then(function (response) {
        if (response == 'success') {
          __WEBPACK_IMPORTED_MODULE_8_vant__["n" /* Toast */].success('点餐成功！');
        }
      }).catch(function (error) {
        console.log(error);
      });
...
// EXTERNAL MODULE: ../touchui/dist/components/row-list.js
var row_list = __webpack_require__(241);

// EXTERNAL MODULE: ../touchui/dist/components/image.js
var components_image = __webpack_require__(48);

// EXTERNAL MODULE: ../touchui/dist/components/badge.js
var badge = __webpack_require__(107);
...
var col = __webpack_require__(51);

// EXTERNAL MODULE: ../touchui/dist/components/row.js
var row = __webpack_require__(52);

// EXTERNAL MODULE: ../touchui/dist/components/nav-bar.js
var nav_bar = __webpack_require__(46);

// EXTERNAL MODULE: ../touchui/dist/components/page.js + 1 modules
var page = __webpack_require__(35);
...
const webSocket = {
    ...
    methods: {
        ...
        bindUid(data){
            let that=this
            if(data.type=='init'){
                this.fetch(api["a" /* Api */].bind.path,  {
                    method:'POST',
                    data: {
...
// CONCATENATED MODULE: ../babel-loader/lib!../touchui-pre-loader/src/script-loader.js!../touchui-loader/lib/selector.js?type=script&index=0!./src/pages/member/user.ui
//
//
//
//
...
/* harmony default export */ var user = __webpack_exports__["default"] = ({
  components: {
    UiPage: page["a" /* default */],
    UiNavBar: nav_bar["a" /* default */],
    UiRow: row["a" /* default */],
    UiCol: col["a" /* default */],
    UiView: view["a" /* default */],
    UiIcon: icon["a" /* default */],
    UiBadge: badge["a" /* default */],
    UiImage: components_image["a" /* default */],
    UiRowList: row_list["a" /* default */]
  },
